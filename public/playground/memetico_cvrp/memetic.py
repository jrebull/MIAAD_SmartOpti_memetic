...
def algoritmo_memetico(
    ...
    *,
    ...
    on_generation
        Callback opcional invocado al final de cada generación con un dict:
        `{gen, mejor_global, mejor_gen, promedio, diversidad, mejor_cromosoma}`.
        Útil para streaming de progreso (UI en vivo, telemetría).
