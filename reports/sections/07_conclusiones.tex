...
\begin{enumerate}
    ...
    \item La fusión GA + Tabú aporta valor real frente a un GA puro: la Tabú acepta empeoramientos temporales (métrica \texttt{aceptaciones\_no\_mejorantes\_tabu} positiva en todos los \emph{runs}), lo que produce mejoras tardías en el histórico de convergencia que un GA puro tendería a perderse.
\end{enumerate}
