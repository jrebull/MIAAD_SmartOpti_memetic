...
Se evalúa el algoritmo memético sobre tres escenarios CVRP deterministas. Cada instancia se genera con una semilla específica y queda persistida en \texttt{data/raw/} junto con su archivo \texttt{.meta.json} (que registra parámetros, hash MD5 y \emph{timestamp}).
...
\begin{tabular}{lrrrl}
\toprule
Escenario & $N$ clientes & $Q$ & Semilla instancia & \emph{Seeds} runs \\
\midrule
Caso 1 — Escala Media           & 50  & 100 & 20\,260\,201 & 2026, 2027, 2028, 2029, 2030 \\
Caso 2 — Alta Densidad          & 100 & 30  & 20\,260\,202 & 2026, 2027, 2028, 2029, 2030 \\
Caso 3 — Consolidación          & 75  & 200 & 20\,260\,203 & 2026, 2027, 2028, 2029, 2030 \\
\bottomrule
\end{tabular}
\end{table}
...
Todos los experimentos se ejecutan localmente (no se usa cómputo distribuido). El entorno está documentado en \texttt{requirements.txt}: NumPy 2.4, SciPy 1.17, pytest 9.0, Python 3.11+. La máquina de referencia es macOS 25.5 con Python 3.14.
